...
import { Button, type TableProps, notification } from 'antd';
...
import FormMasiveCerticates from './FormMasiveCerticates';
...
const UploadStudent = ({ data, preimpress }: { data: number | null; preimpress: string }) => {
  ...
  const [showBulkUploadParticipants, setShowBulkUploadParticipants] = useState(false);
  ...
  const closeBulkUploadModal = () => {
    setShowBulkUploadParticipants(false);
    loadData(data as number);
  }
  ...
  return (
    <>
        ...
        <Datatable<CertifiedStudent>
          ...
          endContent={
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                variant="outlined"
                size="large"
                onClick={() => setShowBulkUploadParticipants(true)}
              >
                Cargar Masivo
          ...
          expandable={{
            expandedRowRender: (record: CertifiedStudent) => (
              <div className="grid w-full grid-cols-4 gap-2 px-2 py-3">
                <div className="flex items-center gap-2">
      ...
      {showBulkUploadParticipants && (
        <FormMasiveCerticates
          preimpreso={preimpress}
          isOpen={showBulkUploadParticipants}
          action={() =>{ closeBulkUploadModal()}}
