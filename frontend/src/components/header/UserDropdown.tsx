      ...
      >
        ...
        <ul className="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
          <li>
            ...
            >
                <CgArrowsExchange className="text-2xl fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300" />
        ...
        >
         <PiSignOutFill className='text-2xl fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300' />
          Cerrar sesión
        </Link>
      </Dropdown>
    </div>
